<div class="col-md-12 mb-4 mt-4">
  <div class="card">
    ...
    <div class="card-body table-responsive col-md-12">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-4">
            <select class="form-control" id="statuspinjaman" name="statuspinjaman">
                ...
                <option value="Tidak Pinjaman">Tidak Pinjaman</option>                
            </select>
        </div>
      </div>    
      ...
      <div class="form-group row" id="range-row">
        <label class="col-md-2 col-form-label" for="text-input">Tingkatan</label>
        <div class="col-md-2">
